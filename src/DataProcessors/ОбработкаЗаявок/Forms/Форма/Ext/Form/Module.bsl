...
Функция ПолучитьТекстЗапросаНеобработанные() Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗаявкиОтправлено КАК ЗаявкиОтправлено
	|		ПО ЗаявкиСтроки.ИдСтроки = ЗаявкиОтправлено.ИдСтроки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗаявкиТендер КАК ЗаявкиТендер
	|		ПО ЗаявкиСтроки.ИдСтроки = ЗаявкиТендер.ИдСтроки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗаявкиСтрокиНаОтмену КАК ЗаявкиСтрокиНаОтмену
	|		ПО ЗаявкиСтроки.ИдСтроки = ЗаявкиСтрокиНаОтмену.ИдСтроки
	|ГДЕ
	|	ЗаявкиСтроки.ПереченьЗакупа В(&ПеречниЗакупа)
	|	И ЗаявкиОтправлено.ИдСтроки ЕСТЬ NULL
	|	И ЗаявкиТендер.ИдСтроки ЕСТЬ NULL
	|	И ЗаявкиСтрокиНаОтмену.ИдСтроки ЕСТЬ NULL
