...
Функция ПолучитьТекстЗапросаОтправленные() Экспорт
	...
	Возврат
	"ВЫБРАТЬ
	|	ЗаявкиОтправлено.ИдентификаторСтроки,
	...
	|		ПО ЗаявкиОтправлено.ИдентификаторСтроки = ЗаявкаСтроки.ИдентификаторСтроки
	|ГДЕ
...
Функция ПолучитьТекстЗапросаОтмененные() Экспорт
	...
	Возврат
	"ВЫБРАТЬ
	|	ЗаявкаСтрокиОтмененные.ИдентификаторСтроки,
	...
	|		ПО ЗаявкаСтрокиОтмененные.ИдентификаторСтроки = ЗаявкаСтроки.ИдентификаторСтроки
	|ГДЕ
...
Процедура СтрокиТендерПриАктивизацииСтроки(Элемент)
	...
	//ЗаполнитьТаблицу("Контрагенты", Новый Структура("ИдентификаторСтроки", ));
...
Процедура ОтправитьПочтуНаСервере()
	...
	Запрос = Новый Запрос(
	"ВЫБРАТЬ
	|	НоменклатураДляОтправки.ИдентификаторСтроки,
