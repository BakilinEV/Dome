...
Функция ПолучитьСписокКартинок()
	...
	Для Каждого ОбщаяКартинка Из Метаданные.ОбщиеКартинки Цикл
		...
		Картинка = БиблиотекаКартинок[ОбщаяКартинка.Имя];
		Список.Добавить(Картинка, ОбщаяКартинка.Синоним,, Картинка);
...
Процедура КартинкаНажатие(Элемент, СтандартнаяОбработка)
	...
	ПолучитьСписокКартинок().ПоказатьВыборЭлемента(ОповещениеВыбора,, Элементы.Картинка);
