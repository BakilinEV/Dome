...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого СтрокаОписания Из ТаблицаОписания Цикл
		...
		КраткийСоставДокумента = КраткийСоставДокумента+
								 ?(ПустаяСтрока(КраткийСоставДокумента), "", "; ")+
								 СтрокаОписания.Наименование+
								 ?(СтрокаОписания.Количество > 1, " ("+СтрокаОписания.Количество+")", "");
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	|	ЗаявкаТовары.СтатусСрочности КАК СтатусСрочности,
