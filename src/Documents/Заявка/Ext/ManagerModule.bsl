...
Функция ПечатьЗаявки(МассивОбъектов, ОбъектыПечати)
	...
	|	ЗаявкаОтПокупателя.Ответственный.ФизическоеЛицо КАК Ответственный,
	|	ЗаявкаОтПокупателя.СуммаДокумента
	|ИЗ
	|	Документ.Заявка КАК ЗаявкаОтПокупателя
	|ГДЕ
	...
	|ИЗ
	|	Документ.Заявка.Товары КАК ЗаявкаОтПокупателяТовары
