...
Процедура АвтоматическийСтатус(ИдентификаторСтроки) Экспорт
	
	Статус = ПолучитьСтатус(ИдентификаторСтроки);
	
	Если Статус.Пустая() Тогда
		УстановитьСтатус(ИдентификаторСтроки, Справочники.СтатусыЗаявки.ПолучитьСтатусНачало());
	КонецЕсли;
...
Функция УстановитьПредыдущийСтатус(ИдентификаторСтроки) Экспорт
	...
	Если ПолучитьСтатус(ИдентификаторСтроки) <> Справочники.СтатусыЗаявки.ПолучитьСтатусОтмена() Тогда
		Возврат Ложь;
	КонецЕсли;
